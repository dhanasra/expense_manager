...
class _DropdownMenu<T> extends StatefulWidget {
  ...
  final VoidCallback? bottomButtonClick;
  final BoxDecoration? dropdownDecoration;
            ...
            child: Material(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if(widget.bottomButtonClick != null) GestureDetector(
                    onTap: widget.bottomButtonClick,
                    child: Container(
                      ...
                      child: Text(widget.bottomButtonText!, style: const TextStyle(
                          color: primary,
...
class DropdownButton2State<T> extends State<DropdownButton2<T>>
  ...
  void _handleTap() {
    ...
    _dropdownRoute = _DropdownRoute<T>(
      items: menuItems,
      bottomButtonText: widget.bottomButtonText,
      bottomButtonClick: widget.bottomButtonClick,
      buttonRect: _rect,
